...
void StageSelectScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Select Stage", "pirulen.ttf", 72, halfW, halfH / 4, 255, 255, 255, 255, 0.5, 0.5));
    ...
    AddNewObject(new Engine::Label("Stage 1", "pirulen.ttf", 48, halfW, halfH - 50, 0, 0, 0, 255, 0.5, 0.5));
    ...
    AddNewObject(new Engine::Label("Stage 2", "pirulen.ttf", 48, halfW, halfH + 100, 0, 0, 0, 255, 0.5, 0.5));
    ...
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW, halfH + 250, 0, 0, 0, 255, 0.5, 0.5));
}
